...
public class PatientServiceTest extends BaseContextSensitiveTest {
	...
	/**
	 * @verifies fail if not preferred patient has active orders
	 * @see PatientService#mergePatients(org.openmrs.Patient, org.openmrs.Patient)
	 */
	@Test
	public void mergePatients_shouldFailIfNotPreferredPatientHasActiveOrders() throws Exception {
	...
	/**
	 * @verifies should not fail if not preferred patient has inactive orders
	 * @see PatientService#mergePatients(org.openmrs.Patient, org.openmrs.Patient)
	 */
	@Test
	public void mergePatients_shouldNotFailIfNotPreferredPatientHasInActiveOrders() throws Exception {
		Patient preferredPatient = patientService.getPatient(8);
		Patient notPreferredPatient = patientService.getPatient(7);
		List<Order> allOrdersByPatient = Context.getOrderService().getAllOrdersByPatient(notPreferredPatient);
